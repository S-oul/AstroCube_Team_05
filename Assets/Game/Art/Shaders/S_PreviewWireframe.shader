Shader "Custom/S_PreviewWireframe"
{
    Properties
    {
        _WireThickness ("Wire Thickness", RANGE(0, 800)) = 100
        _WireColor ("Wire Thickness", RANGE(0, 800)) = 100
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(g2f i) : SV_Target
            {
                ...
                const half4 colors[11] = {
                        half4(1.0, 1.0, 1.0, 0.0),  // White
                        half4(1.0, 0.0, 0.0, 0.0),  // Red
                        half4(0.0, 1.0, 0.0, 0.0),  // Green
                        half4(0.0, 0.0, 1.0, 0.0),  // Blue
                        half4(1.0, 1.0, 0.0, 0.0),  // Yellow
                        half4(0.0, 1.0, 1.0, 0.0),  // Cyan/Aqua
                        half4(1.0, 0.0, 1.0, 0.0),  // Magenta
                        half4(0.5, 0.0, 0.0, 0.0),  // Maroon
                        half4(0.0, 0.5, 0.5, 0.0),  // Teal
                        half4(1.0, 0.65, 0.0, 0.0), // Orange
                        half4(1.0, 1.0, 1.0, 0.0)   // White
                };
                ...
                half4 finalColor = lerp(float4(0,0,0,0), wireColor, t);
                //finalColor.a = t;
