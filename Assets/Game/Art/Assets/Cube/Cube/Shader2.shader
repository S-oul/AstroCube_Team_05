	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Color = ( saturate( hsvTorgb186 ) * _HDR );
...
Node;AmplifyShaderEditor.GradientNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;172;-320,-496;Inherit;False;0;3;2;0.1245283,0,0.06397785,0;0.8705882,0,1,0.6858778;0.9890856,0.9113207,1,1;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=D7A6ECCC145CC04D8A96911F8AB8E7A3E1DEAE41